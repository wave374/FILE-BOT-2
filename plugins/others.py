...
async def home(client: Client, query: CallbackQuery):
    buttons = [
    [InlineKeyboardButton("• ᴄʜᴀɴɴᴇʟꜱ •", url="https://t.me/Animeflio")],
...
async def about(client: Client, query: CallbackQuery):
    buttons = [[InlineKeyboardButton("ʙᴀᴄᴋ", callback_data = "home"), InlineKeyboardButton("ᴄʟᴏꜱᴇ", callback_data = "close")]]
    await query.message.edit_text(
